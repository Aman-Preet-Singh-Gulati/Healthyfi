...
def heartdisease():
    if request.method == 'POST':
        ...
        if prediction==1:
            return render_template('heart.html', prediction_text="Oops! You seem to have a Heart Disease.", title='Heart Disease')
        else:
            return render_template('heart.html', prediction_text="Great! You don't have any Heart Disease.", title='Heart Disease')
    else:
